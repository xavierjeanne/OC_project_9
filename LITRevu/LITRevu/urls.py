...
urlpatterns = [
     ...
     path("posts/",
          ...
          name="posts"),
     path("follows/",
          tickets.views.follow_user,
          name="follows"),
     path("unfollow/<int:followed_id>/",
          tickets.views.unfollow_view,
          name="unfollow"),
     path('search-users/',
          tickets.views.search_users, name='search_users'),
]
